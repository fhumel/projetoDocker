 ...
 */
class TransferEntity extends DefaultEntity
{
    /** @var integer */
    private ?int $id = null;
     ...
     * @param integer $payer
     */
    public function setPayer(int $payer): TransferEntity
    {
        $this->payer = $payer;
    }
     ...
     * @param integer $payee
     */
    public function setPayee(int $payee): TransferEntity
    {
        $this->payee = $payee;
    }
     ...
     * @param float $value
     */
    public function setValur(int $value): TransferEntity
    {
        $this->value = $value;
    }
